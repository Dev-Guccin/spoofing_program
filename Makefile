#############################################################################
# Makefile for building: packet
# Generated by qmake (3.1) (Qt 5.13.0)
# Project:  packet.pro
# Template: app
# Command: /home/kjh/Qt/5.13.0/gcc_64/bin/qmake -o Makefile packet.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../Qt/5.13.0/gcc_64/mkspecs/linux-g++
QMAKE         = /home/kjh/Qt/5.13.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/kjh/Qt/5.13.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/kjh/Qt/5.13.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = packet1.0.0
DISTDIR = /home/kjh/packet/.tmp/packet1.0.0
LINK          = g++
LFLAGS        = 
LIBS          = $(SUBLIBS) -lpcap   
AR            = ar cqs
...
Makefile: packet.pro ../Qt/5.13.0/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt/5.13.0/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt/5.13.0/gcc_64/mkspecs/common/unix.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/linux.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/sanitize.conf \
		../Qt/5.13.0/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../Qt/5.13.0/gcc_64/mkspecs/features/lex.prf \
		packet.pro
	$(QMAKE) -o Makefile packet.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
